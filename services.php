...
<main>
			...
			<div class="row justify-content-center text-center m-b-50 m-b-xs-40">
				<div class="col-xl-6">
					<div class="common-subtitle" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
						<img alt="icon-1" src="assets/img/icons/icon-2.svg"> <span>What We Do</span>
					</div>
			...
			<div class="row" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-63.webp"></a>
							<div class="tag">
								<p>No - 01</p>
							</div>
							<div class="content">
								...
								<div class="join-us">
									<a class='e-primary-btn has-icon is-hover-white' href='services-details.html'>Read More <span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-64.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-65.webp"></a>
							<div class="tag">
								<p>No - 03</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-66.webp"></a>
							<div class="tag">
								<p>No - 04</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-67.webp"></a>
							<div class="tag">
								<p>No - 05</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-4 m-b-30">
					<div class="project-card style-service">
						<div class="thumb">
							<a href='services-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-68.webp"></a>
							<div class="tag">
								<p>No - 06</p>
							</div>
							<div class="content">
	...
	<div class="process-section p-t-140 p-b-100">
					...
					<div class="row justify-content-center text-center m-b-50 m-b-xs-40">
						<div class="col-xl-6">
							<div class="common-subtitle" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
								<img alt="icon-1" src="assets/img/icons/icon-2.svg"> <span>Work Process</span>
							</div>
		...
		<div class="c-shape-1"><img alt="shape-32" src="assets/img/shapes/shape-32.webp"></div>
	</div>
	<!-- process-section end -->
			...
			<div class="row faq">
				<div class="col-xl-5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
					<div class="common-subtitle">
						<img alt="icon-2" src="assets/img/icons/icon-2.svg"> <span>Question &amp; Answer</span>
					</div>
					...
					<div class="blog-btn">
						<a class='e-primary-btn has-icon' href='contact.html'>Have You Any Questions? <span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span></a>
					</div>
					<div class="top-right">
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="contact-info-layout">
						...
						<a class="contact-info" href="tel:+70264566579">
							<div class="icon-wrap">
								<div class="icon-shape"></div>
								<div class="icon">
