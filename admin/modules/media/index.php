<?php
/**
 * Media Coverage Management - List Images
 */

require_once dirname(dirname(__DIR__)) . '/init.php';
require_login();
require_module('media');
require_permission('media_view');

$page_title = 'Media Coverage Images';
...
try {
  ...
  set_flash('error', 'Failed to fetch media images: ' . $e->getMessage());
  $images = [];
}
...
<div class="page-header d-flex justify-content-between align-items-center">
  <h1><i class="bi bi-newspaper me-2"></i>Media Coverage Images</h1>
  <?php if (has_permission('media_create')): ?>
    <a href="<?php echo ADMIN_URL; ?>/modules/media/create.php" class="btn">
  ...
  <div class="card-body">
    <?php if (empty($images)): ?>
      <div class="text-center py-5">
        ...
        <a href="<?php echo ADMIN_URL; ?>/modules/media/create.php" class="btn btn-primary">
    ...
    <?php else: ?>
      ...
      <?php echo create_pagination($page, $totalPages, ADMIN_URL . '/modules/media/index.php'); ?>
    <?php endif; ?>
  </div>
</div>
